...
- [x] Update CLAUDE.md testing section to mention HITL E2E tests and how to run them
- [x] Add run instructions to `tests/e2e/test_hitl_review.py` docstring (similar to `test_llm_dropdowns.py`)
