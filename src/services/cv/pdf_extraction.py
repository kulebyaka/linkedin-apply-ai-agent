...
async def run_extraction(
    ...
    # Instructor's ``response_model`` path returns a validated model; normalize
    # it to a dict so the downstream soft-validation/serialization is uniform
    # (a raw-dict fallback path returns a dict as-is).
